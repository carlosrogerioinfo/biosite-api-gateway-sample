...
namespace Biosite.Domain.Entities
{
    public class User : Entity
    {
        ...
        public User(Guid id, string name, string password, string confirmPassword, string email, double weight, double height, Gender gender, DateTime birthdate, Guid planId, bool isPregnant = false)
        {
            Id = id;
            Name = name;
