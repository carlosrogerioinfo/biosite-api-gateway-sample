...
namespace Biosite.Infrastructure.Mappings
{
    public class BiomarkerMap : IEntityTypeConfiguration<Biomarker>
    {
        public void Configure(EntityTypeBuilder<Biomarker> entity)
        {
            ...
            entity.Property(x => x.AboveImpact).IsRequired().HasMaxLength(1000).HasColumnType(Constants.Varchar);
            entity.Property(x => x.BelowImpact).IsRequired().HasMaxLength(1000).HasColumnType(Constants.Varchar);
