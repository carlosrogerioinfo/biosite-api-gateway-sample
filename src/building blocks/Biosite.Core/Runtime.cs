namespace Biosite.Core
{
    ...
    {
        public static string ConnectionString = "Server=seu-servidor-de-banco-de-dados;Database=nome-do-seu-database;User ID=usuario-do-banco-de-dados;Password=senha-do-banco-de-dados;";
